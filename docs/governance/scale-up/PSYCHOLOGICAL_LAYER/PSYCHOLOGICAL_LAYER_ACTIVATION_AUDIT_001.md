# Psychological Layer activation audit 001
...
| --- | ---: |
| `READY_FOR_ACTIVATION_REVIEW` | 18 |
| `KEEP_INACTIVE` | 22 |
| `BLOCKED` | 5 |
| New `ACTIVE` | 0 |
...
- `EA-V1-PSY-LAYER-012`
- `EA-V1-PSY-LAYER-023`
- `EVA-AE-V1-PSY-LAYER-002`
- `EVA-AE-V1-PSY-LAYER-003`
- `EVA-AE-V1-PSY-LAYER-005`
- `EVA-AE-V1-PSY-LAYER-007`
- `EVA-AE-V1-PSY-LAYER-012`
- `EVA-AE-V1-PSY-LAYER-023`
...
Exact recommended activation-review subset: 18 records in six dependency bundles. Exact keep-inactive subset: 22 identity records. Exact blocked subset: 5 repetition records. New `ACTIVE` = 0.

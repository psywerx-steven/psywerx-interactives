...
def _presentation_copy() -> dict[str, Any]:
    return {
        ...
        "entries": [
            ...
            {"key": "narratives", "description": "Broader interpretations integrating multiple findings."},
            {"key": "findings-open-questions", "description": "Specific takeaways and unresolved questions."},

"""Narrow authoritative identity verification for Biological candidate sources."""
...
PATH = ROOT / "data/candidates/actions-events-v1/BIOLOGICAL_LAYER/candidate-source-registry.json"
...
def verify() -> None:
    ...
    print(f"Verified {len(sources)} Biological candidate source identities through PubMed/NCBI Eutilities")
